...
echo "<br/>";
echo $row['name'];
echo "<br/>created on : ".$row['date_intro'];
echo "<br/><br/>".$row['about'];
?>
</p2>
</ul>
<?php
$query="select users.id, from users,groups,bel_user_grp where groups.id=bel_user_grp.groupid and bel_user_grp.groupid=groups.id and groups.id=$gid and users.id=$uid";
$result=mysql_query($query);
$cnt = mysql_num_rows($result);
if($cnt==0)
{
echo "<br><a href='joinus.php?gid=$gid' method='get'>";
echo "<img src='join_us.png' alt='Join us Button' width='15%' height='4%' align='top' />";
echo "</a>";
