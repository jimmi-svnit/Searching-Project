...
$query="insert into stk_user_top values($uid,$tid,'$date[year]-$date[mon]-$date[mday]')";
$result=mysql_query($query);
if($result==0)
{
	echo "<br/>there was some problem, try later...";
}
else
{
	echo "<br/>you are now free to stalk this topic!";
}
?>
</b></big>
<br/>
