...
$query="select id,name from topics where name like '%$text%' or tags like '%$text%' order by name";
$result=mysql_query($query);
$cnt = mysql_num_rows($result);
if($cnt==0)
{	echo "No serch results available";	}
else
{
echo "<div class='ex'><b><big>Probable Answers:....</big></b><br/>";
	while($row = mysql_fetch_array($result))
	{	echo "<a href='thetopic.php?topic=$row[0]'>$row[1]</a><br/>";
	}
echo "</div>";
}
