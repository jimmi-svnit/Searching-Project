...
$query="delete from stk_user_top where userid=$uid and topicid=$tid";
$result=mysql_query($query);
if($result==0)
{
	echo "<form action='' method='get'><center><p2><b><big> <br/><br>There was some problem, try again later...</big></b></p2></center>";

}
else
{
	echo "<form action='' method='get'><center><p2><b><big> <br/><br>You are not stalking this topic anymore.</big></b></p2></center>";
